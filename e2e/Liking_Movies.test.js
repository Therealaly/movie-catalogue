...
Before(({ I }) => {
  // kalau di restorant sepertinya jadi /#/favorite
  I.amOnPage('/#/like');
});
...
Scenario('test something', ({ I }) => {
  // menguji keberadaan elemen #query
  I.seeElement('#query');
  // Saya melihat teks ‘Tidak ada film untuk ditampilkan’ pada elemen .movie-item__not__found”.
